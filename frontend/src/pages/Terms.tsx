      ...
      <div className="prose prose-gray max-w-none text-sm sm:text-base">
        <div className="space-y-6 sm:space-y-8">
          <p className="leading-relaxed">
            この利用規約（以下、「本規約」といいます。）は、推しおめ運営事務局（以下、「当事務局」といいます。）が提供する推しの誕生日を、みんなで祝おうをコンセプトとしたクラウドファンディングサービス「推しおめ」（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
          </p>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>犯罪行為に関連する行為</li>
              <li>
                当事務局、本サービスの他のユーザー、または第三者のサーバーまたはネットワークの機能を破壊したり、妨害したりする行為
              </li>
